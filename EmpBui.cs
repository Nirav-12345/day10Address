...
namespace EmpUC10
{
    public class EmpBui
    {
        ...
        public void U10C(string company, int emprateperhr, int NumOfWorkingDays, int MaxHourPerMonth)
        {

            CompanyEmpWageArr[this.numOfCompany] = new CompanyEmpWage(company, emprateperhr, NumOfWorkingDays, MaxHourPerMonth);
